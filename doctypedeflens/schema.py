...
Every record carries its phase, scores, assertion results, and (when the
rollout produced them) the conversation and per-item usage. A record without
a conversation was not observed; a claim standing on it is not measured.
"""
